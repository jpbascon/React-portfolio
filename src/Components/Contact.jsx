...
const Contact = ({ dropDownOpen }) => {
  return (
    <>
      <div className={"flex items-center justify-center m-[6%] mt-[5rem] md:mt-[7rem] lg:mt-[15rem] projects-wrapper" + (dropDownOpen ? " active" : " ")}>
        <div className="flex flex-col lg:flex-row items-strech gap-6 lg:gap-[4rem] w-full">
          <section className="flex flex-col gap-4 justify-center items-center paragraph-animate-right w-full">
            ...
            <div className="flex justify-center gap-5 pt-5 w-full">
              ...
              <a href="https://github.com/jpbascon" target="_blank">
                <svg className="transition-[fill] relative hover:fill-green-400 w-[26px] z-1" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" fill="#FFF">
                  <g>
          ...
          <div className="flex items-center justify-center gap-4 flex-row lg:flex-col">
            <div className="flex-1 border-t lg:border-l border-green-400 opacity-100 spacers"></div>
            <p className="px-2 text-green-400 opacity-100 spacers">or</p>
            <div className="flex-1 border-t lg:border-l border-green-400 opacity-100 spacers"></div>
          </div>
